...
// OPTION 2: Zigzag Alternating Layout
// Visual flow: Steps alternate left and right with connecting line in center
export default function ProcessSteps_Option2() {
  const steps = [
    {
      number: 1,
